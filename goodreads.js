import { FROM_CACHE, getDom, makeQueue, toNormalizedText } from './lib.js'
...
export const loadGoodReadsData = async q => {
  ...
  return adaptResults(
    ...
    mainResults.map(tr => {
      ...
      const [ratingValue, ratingCount] = toNormalizedText(
        minirating.textContent,
      )
        .split(' — ')
...
export const syncBookGR = async book => {
...
export const queueGR = makeQueue(syncBookGR)
